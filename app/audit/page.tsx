    ...
    <PageShell>
      ...
      <header className="mb-6">
        ...
        <h1 className="mt-3 max-w-3xl text-4xl font-semibold tracking-tight sm:text-5xl">
          One prompt is pennies. At org scale, it’s a bleed.
        </h1>
        <p className="mt-3 max-w-2xl text-base font-medium text-zinc-700 dark:text-zinc-300">
          The same waste the optimizer catches in a single prompt — filler, over-tiered models, uncached
          context — compounds across teams. Here’s a 30-day audit of {org.name}.
        </p>
      ...
      <NavButtons
        back={{ href: '/', label: 'Back to the optimizer' }}
        next={{ href: '/solution', label: 'See how we stop the bleed' }}
      />
    </PageShell>
  );
}
